...
long long int state_quality(char color)
{
    int i;
    long long int sum_w = 9999999999;
    long long int sum_b = 9999999999;
    long long int min = 0;
...
long long int play_quality(Game game, char color)
{
    reset(B_BFS);
    reset(W_BFS);
...
int playerNext(Game game, int *x, int *y)
{
    char ally, enemy;
    int i, j;
    long long int max = -99999999999, quality;
    Game bfs = 0;
